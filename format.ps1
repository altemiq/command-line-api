...
dotnet format analyzers $PSScriptRoot --report $(Join-Path $PSScriptRoot analyzers.report.json) --severity info --verbosity diagnostic --exclude-diagnostics S1133 CA1822 --no-restore
